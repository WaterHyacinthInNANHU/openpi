...
desk "cd $TASL && ulimit -n 8192 && PYTHONPATH=$TASL:$SITE_PKGS NUC1_HOST=$NUC1_HOST setsid /usr/bin/python3 dashboards/rlinf.py --port 8003 --mode host </dev/null >> $LOG_DIR/eval.log 2>&1 &"
wait_http 8003 || die "eval dashboard did not answer on :8003 (see $LOG_DIR/eval.log)"
